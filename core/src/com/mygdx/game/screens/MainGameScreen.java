...
//		final TiledMap tiledMap = game.getAssetManager().get("maps/Demo-abandon-village-map.tmx",TiledMap.class);
//		mapRender.setMap(tiledMap);
		
		game.getEcsEngine().createPlayer(mapManager.getCurrentMap().getStartPosition(), 0.5f, 0.5f);
	}
